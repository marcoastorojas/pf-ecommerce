     ...
     <div className="comments">
      <span>
       ...
       <p>
        ...
        asperiores, quisquam ipsa expedita, quae harum sint corporis beatae
        recusandae facere ut inventore ex reiciendis quibusdam eum porro!
        Inventore, itaque.
       </p>
      </span>
      <span>
   ...
   <div className="right">
    ...
    <div className="shopping">
     <div className="pricing">
      ...
      <div className="total">
       total:{" "}
       <span>${Intl.NumberFormat().format(product.data.price * quantity)}</span>
      </div>
     </div>
     <div>
